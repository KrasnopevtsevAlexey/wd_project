		...
		<div class="row justify-content-between align-items-center">
			<div class="col-lg-2 col-6">
				<a href="index.html" class="logo-link">
					<img width="128" src="/imgs/logo.svg" alt="logo: Willberries" class="logo-image">
				</a>
			</div>
			...
			<div class="col-lg-2 col-6 d-flex justify-content-end">
				<button class="button button-cart">
					<img class="button-icon" src="/imgs/cart.svg" alt="icon: cart">
				...
				<div class="row justify-content-between">
					<div class="col-1">
						<button class="slider-button slider-button-prev">
							<img src="/imgs/arrow-prev.svg" alt="icon: arrow-prev">
						</button>
					</div>
					<!-- /.col-1 -->
					<div class="col-1">
						<button class="slider-button slider-button-next">
							<img src="/imgs/arrow-next.svg" alt="icon: arrow-prev">
						</button>
					</div>
					<!-- /.col-1 -->
				</div>
			...
			<div class="col-xl-6">
				<div class="card card-1 mb-4">
					...
					<button class="button">
						...
						<img src="/imgs/arrow.svg" alt="icon: arrow" class="button-icon">
					</button>
				</div>
				<!-- /.card -->
			</div>
		...
		<div class="short-goods row">
			<div class="col-lg-3 col-sm-6">
				<div class="goods-card">
					<span class="label">New</span>
					<!-- /.label --><img src="/imgs/image-119.jpg" alt="image: Hoodie" class="goods-image">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="goods-card">
					<span class="label">New</span>
					<!-- /.label --><img src="/imgs/image-120.jpg" alt="image: Faded Beach Trousers" class="goods-image">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="goods-card">
					<span class="label">New</span>
					<!-- /.label --><img src="/imgs/image-121.jpg" alt="image: Text T-Shirt" class="goods-image">
			...
			<div class="col-lg-3 col-sm-6">
				<div class="goods-card">
					<span class="label">New</span>
					<!-- /.label --><img src="/imgs/image-122.jpg" alt="image: Striped Long Sleeve Shirt"
						class="goods-image">
		...
		<div class="container">
			...
			<div class="row justify-content-between">
				<div class="col-lg-4 col-sm-9">
					<img class="payment-logo" src="/imgs/visa.png" alt="visa logo">
					<img class="payment-logo" src="/imgs/master-card.png" alt="master card logo">
					<img class="payment-logo" src="/imgs/paypal.png" alt="paypal logo ">
					<img class="payment-logo" src="/imgs/bitcoin.png" alt="bitcoin logo">
				</div>
				<!-- /.col-4 -->
				<div class="col-lg-2 col-sm-1 d-flex justify-content-end">
					<a href="#body" class="scroll-link top-link d-flex align-items-center">
						...
						<img src="/imgs/top.svg" alt="icon: arrow top">
					</a>
				</div>
